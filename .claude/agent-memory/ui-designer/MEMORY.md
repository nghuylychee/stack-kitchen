...
- [Extend a BUILT ui spec via a new companion file, not a direct edit](feedback_extend_built_ui_spec_separately.md) — list zone-by-zone impact for human approval instead.
